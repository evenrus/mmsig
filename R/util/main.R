packages <- c("seqinr", "plyr", "tibble", "tidyr", "dplyr", "ggplot2", "reshape2", "RColorBrewer",
              "BSgenome", "TxDb.Hsapiens.UCSC.hg19.knownGene","BSgenome.Hsapiens.UCSC.hg19",
              "MutationalPatterns", "deconstructSigs", "GenomicFeatures")
